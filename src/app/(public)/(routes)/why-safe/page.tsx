...
const WhySafePage = () => {
  ...
  return (
    <div>
      ...
      >
        <div className="flex-1 space-y-5">
          ...
          <p className="text-lg mt-5">
            SAFE is your ultimate solution for secure and easy password
            management, available on Website, Android, iOS, and Chrome extension
          </p>
          <Link
            href="/auth"
      ...
      <div className="my-20 text-center space-y-5 container mx-auto">
        ...
        <p className="text-lg text-muted-foreground">
          There’s a better way to solve the password problem. Dashlane is doing
          what
          <br /> others aren’t—providing complete credential and password
          management. We promise to:
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 h-fit gap-x-10 gap-y-20">
          <GlareCard className="md:px-20 md:py-10 px-10 py-5 w-full space-y-5">
            ...
            <p>
              SAFE uses advanced encryption to keep your passwords and data
              secure. Your master password is hashed and stored safely, ensuring
              even we cannot access it. This robust security guarantees
          ...
          <GlareCard className="md:px-20 md:py-10 px-10 py-5 w-full space-y-5">
            ...
            <p>
              SAFE is available on Website, Android, iOS, and Chrome extension,
              letting you manage your passwords conveniently on any device. Stay
          ...
          <GlareCard className="md:px-20 md:py-10 px-10 py-5 w-full space-y-5">
            ...
            <p>
              SAFE is a free service, offering top-quality password management
              with no hidden fees or subscriptions. Everyone deserves access to
              robust security tools, and SAFE provides just that.
            </p>
          </GlareCard>
          <GlareCard className="md:px-20 md:py-10 px-10 py-5 w-full space-y-5">
            <FaUser size={25} />
            ...
            <p>
              SAFE is meticulously designed by an individual committed to
              creating a trustworthy and reliable password manager. This
              personal touch ensures a focus on user experience and security.
            </p>
          </GlareCard>
        </div>
      </div>
